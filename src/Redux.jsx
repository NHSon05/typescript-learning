        ...
        <div className="p-5">
          <form>
            ...
            <div className="mb-6 flex items-center">
              ...
              /><label for="publish" className="ml-2 text-sm font-medium text-gray-900"
                >Publish</label
              >
            </div>
            <div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 p-4 lg:p-6">
                      ...
                      <h2 className="text-xl font-bold text-gray-800">
                        Muốn thành công thì khao khát thành công phải lớn hơn nỗi sợ
                        bị thất bại.
                      </h2>
                      <p className="text-gray-500">
                        Bạn chớ nên bỏ cuộc khi bạn vẫn còn điều gì đó để cho đi.
                        Không có gì là hoàn toàn bế tắc, sự việc chỉ thật sự trở nên
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 p-4 lg:p-6">
                      ...
                      <h2 className="text-xl font-bold text-gray-800">
                        Mất niềm tin vào bản thân, cũng như bạn đánh mất thành công
                        đang đợi mình
                      </h2>
                      <p className="text-gray-500">
                        Ai cũng nói tương lai chúng ta luôn rộng mở, nhưng nếu không
                        nắm bắt được hiện tại thì tương lai sẽ chẳng có gì.
                      </p>
                      <div>
                        <div className="inline-flex rounded-md shadow-sm" role="group">
                          <button
